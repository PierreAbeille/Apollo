...
export function RecentMovies({ movies }: { movies: Movie[] }) {
    return (
        <div className="bg-base-200 border border-base-300 rounded-xl p-5 h-full shadow-sm relative overflow-hidden group">
            <div className="absolute -top-24 -right-24 w-64 h-64 bg-info/5 blur-[100px] rounded-full pointer-events-none group-hover:bg-info/10 transition-colors duration-700" />
