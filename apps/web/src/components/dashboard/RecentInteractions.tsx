...
export function RecentInteractions({ interactions }: { interactions: Interaction[] }) {
    return (
        <div className="bg-base-200 border border-base-300 rounded-xl p-5 h-full shadow-sm relative overflow-hidden group/main">
            <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-warning/5 blur-[100px] rounded-full pointer-events-none group-hover/main:bg-warning/10 transition-colors duration-700" />
